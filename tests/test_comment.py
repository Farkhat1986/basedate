...
@allure.story("Авторизованный пользователь может создать комментарий к существующему посту")
def test_create_comment(comments_api, created_post):
    ...
    with allure.step("Проверка, что комментарий сохранён в базе данных"):
...
@allure.feature("WordPress Comments API")
@allure.story("Пользователь может получить данные комментария по его ID")
...
@allure.feature("WordPress Comments API")
@allure.story("Авторизованный пользователь может обновить содержимое своего комментария")
...
@allure.feature("WordPress Comments API")
@allure.story("Авторизованный пользователь может удалить свой комментарий")
